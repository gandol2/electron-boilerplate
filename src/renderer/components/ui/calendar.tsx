  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        today: cn(
          // 'bg-accent text-accent-foreground rounded-md data-[selected=true]:rounded-none debug',
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        'h-9 w-9 p-0 font-normal text-center flex flex-col items-center justify-center',
